 ...
 */
 ...
 /*helpers.sendTwilioSms('0729643482', 'Mambo Vipi?', function(err){
...
server.unifiedServer = function(req,res){
   ...
   req.on('end', function() {
       ...
       server.processHandlerResponse(res,method,trimmedPath,statusCode,payload,contentType);
        ...
        debug(e);
        server.processHandlerResponse(res,method,trimmedPath,500,{'Error' : 'An unkwown error has occurred'},'json');
       }
